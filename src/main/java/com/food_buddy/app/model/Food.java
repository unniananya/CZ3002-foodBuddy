...
public class Food {
    ...
    private String food_sub_group;

    private String per_serving_household_measure;
    ...
    public Food(Long id, String food_name, String food_group, String food_sub_group, String per_serving_household_measure, double energy_kcal, double dietary_fibre_g, double carbohydrate_g, double cholesterol_mg, double sodium_mg, double calcium_mg, double polyunsaturated_fat_g, double potassium_mg, double protein_g, double saturated_fat_g, double sugar_g, double total_fat_g, double trans_fat_mg, double vitamin_A_mcg, double vitamin_B2_mg, double vitamin_C_mg, double vitamin_D_IU, double water_g, double zinc_mg) {
        this.id = id;
        this.food_name = food_name;
        this.food_group = food_group;
        this.food_sub_group = food_sub_group;
        this.per_serving_household_measure = per_serving_household_measure;
    ...
    public String getFood_sub_group() {
        return food_sub_group;
    }

    public void setFood_sub_group(String food_sub_group) {
        this.food_sub_group = food_sub_group;
    }

    public String getPer_serving_household_measure() {
        return per_serving_household_measure;
    }

    public void setPer_serving_household_measure(String per_serving_household_measure) {
        this.per_serving_household_measure = per_serving_household_measure;
    }
